...
public interface StampRepository extends Repository<MemberStamp, Long> {
    ...
    @Query("SELECT new com.jungle.Tabbit.domain.stampBadge.dto.SidoStamp(a.sido, COUNT(r.restaurantId), COUNT(ms.restaurant))" +
            "FROM address a " +
            ...
            "GROUP BY a.sido")
    List<SidoStamp> findSidoStampCount(@Param("memberId") Long memberId);
